...
public class BaseViewModel extends ViewModel {
     ...
     */
    public final void showError(@NonNull String msg) {
     ...
     * @param msg To be displayed on UI
     */
    public final void showInfoMsg(@NonNull String msg) {
     ...
     */
    public void dispatchOnFailure(@NonNull  Throwable throwable) {
        hideLoader();
